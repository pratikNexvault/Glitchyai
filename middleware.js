...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .footnote{margin-top:28px;font-size:.62rem;letter-spacing:.08em;color:var(--ink-soft);opacity:.7;}
</style>
</head>
<body>
  <form class="card" id="form">
    ...
    <div id="err"></div>
    <p class="footnote">LUMIS AI &middot; A PART OF THE LUMIS ECOSYSTEM</p>
  </form>
<script>
